...
public class QiniuUtils {
    ...
    public  static String accessKey = "Kw3x6Goku2m_OdVJ3K84zLXoPxqzL6DCGjiqX1NU";
    public  static String secretKey = "BLC5sRhPR3NK_Y0X-FIZpJRoNpDWQIyNVsbo-ILa";
    public  static String bucket = "meinian2023";
